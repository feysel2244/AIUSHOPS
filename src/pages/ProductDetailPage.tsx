...
export default function ProductDetailPage() {
  ...
  <>
    <Helmet>
      <title>{p.name} | AIU Market</title>

      <meta
        name="description"
        content={`Buy ${p.name} from ${p.shopName} on AIU Market. ${p.description}`}
      />

      <meta
        property="og:title"
        content={`${p.name} | AIU Market`}
      />
      ...
      <meta
        property="og:url"
        content={`https://aiumarket.com/product/${p.slug}`}
      />
