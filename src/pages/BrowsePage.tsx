...
export default function BrowsePage() {
  ...
  useEffect(() => {
    async function loadResults() {
      ...
      let productQuery = supabase.from("products").select("*,shops!inner(*,profiles(name,department,year,whatsapp))").is("shops.deleted_at", null).is("deleted_at", null);
      let serviceQuery = supabase.from("services").select("*,shops!inner(*,profiles(name,department,year,whatsapp))").is("shops.deleted_at", null).is("deleted_at", null);
